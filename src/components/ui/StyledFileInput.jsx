  ...
  return (
    <div>
      ...
      <div className="flex border border-gray-300 rounded overflow-hidden focus-within:border-accent">
        ...
        <div className="flex items-center px-3 py-2 space-x-2 relative">
          {!file && !filePath ? (
            ...
            <div className="relative">
              <img src={filePath} alt="Preview" className="w-12 h-12 object-cover rounded border" />
              <button type="button" onClick={handleRemove} className="absolute -top-3 -right-2">
                <Icon icon="mdi:close" width="16" className="rounded-full p-0.5 shadow bg-white hover:bg-gray-100" />
              </button>
            </div>
          )}
        </div>
