        ...
        >
          ...
          >
            ...
            >
              ...
              {title && (
                <Dialog.Title className="text-lg font-medium text-gray-900 px-6 py-4 border-b border-gray-300">
                  {title}
                </Dialog.Title>
              )}
              <div className="px-6 py-4">{children}</div>
              {footer && <div className="px-6 py-4 border-t border-gray-300">{footer}</div>}
            </Dialog.Panel>
          </Transition.Child>
        </div>
      </Dialog>
